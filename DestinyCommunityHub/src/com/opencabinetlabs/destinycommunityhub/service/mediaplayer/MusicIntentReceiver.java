    ...
    public void onReceive(Context context, Intent intent) {
        if (intent.getAction().equals(android.media.AudioManager.ACTION_AUDIO_BECOMING_NOISY)) {
           // Toast.makeText(context, "Headphones disconnected.", Toast.LENGTH_SHORT).show();
            ...
            context.startService(new Intent(PodcastService.ACTION_PAUSE));
            ...
            switch (keyEvent.getKeyCode()) {
                ...
                case KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE:
                    context.startService(new Intent(PodcastService.ACTION_TOGGLE_PLAYBACK));
                    break;
                case KeyEvent.KEYCODE_MEDIA_PLAY:
                    context.startService(new Intent(PodcastService.ACTION_PLAY));
                    break;
                case KeyEvent.KEYCODE_MEDIA_PAUSE:
                    context.startService(new Intent(PodcastService.ACTION_PAUSE));
                    break;
                case KeyEvent.KEYCODE_MEDIA_STOP:
                    context.startService(new Intent(PodcastService.ACTION_STOP));
                    break;
            }
        }
    }
